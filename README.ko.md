...
<small>측정일 2026-06-17 15:28:53 · linux x64 · Node.js v22.22.3</small>
### ioredis 대비 최대 **2.1x 빠릅니다**! 🚀

---
<br/>

**15**개 중 **15**개 벤치마크 우위 · 평균 **76%** 성능 향상 · 최대 **113%** 성능 향상

*100,000번 반복 × 10,000 동시 실행 · 1 KB 페이로드 · 10회 측정*

| | 벤치마크 | 명령어 | solidis | ioredis | 차이 | 성능 |
|---:|:---|:---:|:---:|:---:|:---:|:---|
| 🥇 | **Set 변경** | SADD + SISMEMBER + SREM | **1586ms** | 3371ms | **2.1x** 🔥🔥 | `██████████` |
| 🥈 | **List 범위** | LPUSH + RPUSH + LRANGE | **1858ms** | 3687ms | **2.0x** 🔥🔥 | `█████████░` |
| 🥉 | **Hash 변경** | HMSET + HMGET + HDEL | **1780ms** | 3397ms | **1.9x** 🔥🔥 | `████████░░` |
| 4. | **List 변경** | LPUSH + RPUSH + LPOP + RPOP + LLEN | **2294ms** | 4375ms | **1.9x** 🔥🔥 | `████████░░` |
...
| 10. | **Set 조회** | SADD + SISMEMBER + SMEMBERS | **1518ms** | 2646ms | **1.7x** 🔥🔥 | `███████░░░` |
| 11. | **비트랜잭션** | SETPX + GET | **1294ms** | 2184ms | **1.7x** 🔥🔥 | `██████░░░░` |
| 12. | **파이프라인 혼합** | SET + INCR + GET | **1775ms** | 2884ms | **1.6x** 🔥🔥 | `██████░░░░` |
| 13. | **Hash 왕복** | HSET + HGET + HGETALL | **1749ms** | 2720ms | **1.6x** 🔥 | `█████░░░░░` |
...
| | 벤치마크 | 명령어 | solidis | ioredis | 차이 | 성능 |
|---:|:---|:---:|:---:|:---:|:---:|:---|
| 16. | **트랜잭션** | SET + EXPIRE + GET | 1276ms | 5043ms | **4.0x** 🔥🔥 | `██████████` |
| 17. | **트랜잭션 혼합** | SET + GET | 1660ms | 6084ms | **3.7x** 🔥🔥 | `██████████` |
...
|:---|:---|---:|---:|---:|---:|
| **Set 변경: SADD + SISMEMBER + SREM**<br/><sub>1 KB</sub> | **solidis** | 63.1K | 189.2K | 1586ms | ±2.3% |
|  | ioredis | 29.7K | 89.0K | 3371ms | ±2.6% |
| **List 범위: LPUSH + RPUSH + LRANGE**<br/><sub>1 KB</sub> | **solidis** | 53.8K | 161.4K | 1858ms | ±10.6% |
|  | ioredis | 27.1K | 81.4K | 3687ms | ±0.9% |
| **Hash 변경: HMSET + HMGET + HDEL**<br/><sub>1 KB</sub> | **solidis** | 56.2K | 168.6K | 1780ms | ±5.7% |
|  | ioredis | 29.4K | 88.3K | 3397ms | ±1.0% |
| **List 변경: LPUSH + RPUSH + LPOP + RPOP + LLEN**<br/><sub>1 KB</sub> | **solidis** | 43.6K | 218.0K | 2294ms | ±1.3% |
...
| **Set 조회: SADD + SISMEMBER + SMEMBERS**<br/><sub>1 KB</sub> | **solidis** | 65.9K | 197.7K | 1518ms | ±4.1% |
|  | ioredis | 37.8K | 113.4K | 2646ms | ±1.6% |
| **비트랜잭션: SETPX + GET**<br/><sub>1 KB</sub> | **solidis** | 77.3K | 154.5K | 1294ms | ±5.9% |
|  | ioredis | 45.8K | 91.6K | 2184ms | ±1.4% |
| **파이프라인 혼합: SET + INCR + GET**<br/><sub>1 KB</sub> | **solidis** | 56.3K | 169.0K | 1775ms | ±5.4% |
|  | ioredis | 34.7K | 104.0K | 2884ms | ±4.6% |
| **Hash 왕복: HSET + HGET + HGETALL**<br/><sub>1 KB</sub> | **solidis** | 57.2K | 171.5K | 1749ms | ±5.6% |
