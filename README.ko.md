...
<small>측정일 2026-06-17 15:45:00 · linux x64 · Node.js v22.22.3</small>
### ioredis 대비 최대 **2.1x 빠릅니다**! 🚀

---
<br/>

**15**개 중 **15**개 벤치마크 우위 · 평균 **75%** 성능 향상 · 최대 **110%** 성능 향상

*100,000번 반복 × 10,000 동시 실행 · 1 KB 페이로드 · 10회 측정*

| | 벤치마크 | 명령어 | solidis | ioredis | 차이 | 성능 |
|---:|:---|:---:|:---:|:---:|:---:|:---|
| 🥇 | **Set 변경** | <sup><sub><kbd>SADD</kbd> <kbd>SISMEMBER</kbd> <kbd>SREM</kbd></sub></sup> | **1568ms** | 3289ms | **2.1x** 🔥🔥 | `██████████` |
| 🥈 | **List 변경** | <sup><sub><kbd>LPUSH</kbd> <kbd>RPUSH</kbd> <kbd>LPOP</kbd> <kbd>RPOP</kbd> <kbd>LLEN</kbd></sub></sup> | **2311ms** | 4407ms | **1.9x** 🔥🔥 | `████████░░` |
| 🥉 | **Hash 변경** | <sup><sub><kbd>HMSET</kbd> <kbd>HMGET</kbd> <kbd>HDEL</kbd></sub></sup> | **1904ms** | 3561ms | **1.9x** 🔥🔥 | `████████░░` |
| 4. | **Multi-Key** | <sup><sub><kbd>MSET</kbd> <kbd>MGET</kbd></sub></sup> | **1636ms** | 3057ms | **1.9x** 🔥🔥 | `████████░░` |
| 5. | **List 범위** | <sup><sub><kbd>LPUSH</kbd> <kbd>RPUSH</kbd> <kbd>LRANGE</kbd></sub></sup> | **1856ms** | 3429ms | **1.8x** 🔥🔥 | `████████░░` |
| 6. | **Set 조회** | <sup><sub><kbd>SADD</kbd> <kbd>SISMEMBER</kbd> <kbd>SMEMBERS</kbd></sub></sup> | **1745ms** | 3195ms | **1.8x** 🔥🔥 | `████████░░` |
| 7. | **Sorted Set** | <sup><sub><kbd>ZADD</kbd> <kbd>ZRANGE</kbd> <kbd>ZREM</kbd></sub></sup> | **1921ms** | 3454ms | **1.8x** 🔥🔥 | `███████░░░` |
| 8. | **비트랜잭션** | <sup><sub><kbd>SETPX</kbd> <kbd>GET</kbd></sub></sup> | **1224ms** | 2155ms | **1.8x** 🔥🔥 | `███████░░░` |
...
| 11. | **Hash 왕복** | <sup><sub><kbd>HSET</kbd> <kbd>HGET</kbd> <kbd>HGETALL</kbd></sub></sup> | **1811ms** | 2917ms | **1.6x** 🔥🔥 | `██████░░░░` |
| 12. | **파이프라인 혼합** | <sup><sub><kbd>SET</kbd> <kbd>INCR</kbd> <kbd>GET</kbd></sub></sup> | **1663ms** | 2652ms | **1.6x** 🔥 | `█████░░░░░` |
...
| | 벤치마크 | 명령어 | solidis | ioredis | 차이 | 성능 |
|---:|:---|:---:|:---:|:---:|:---:|:---|
| 16. | **트랜잭션** | <sup><sub><kbd>SET</kbd> <kbd>EXPIRE</kbd> <kbd>GET</kbd></sub></sup> | 1311ms | 6444ms | **4.9x** 🔥🔥 | `██████████` |
| 17. | **트랜잭션 혼합** | <sup><sub><kbd>SET</kbd> <kbd>GET</kbd></sub></sup> | 1691ms | 6302ms | **3.7x** 🔥🔥 | `██████████` |
...
|:---|:---|---:|---:|---:|---:|
| **Set 변경: <sup><sub><kbd>SADD</kbd> <kbd>SISMEMBER</kbd> <kbd>SREM</kbd></sub></sup>**<br/><sub>1 KB</sub> | **solidis** | 63.8K | 191.3K | 1568ms | ±1.5% |
|  | ioredis | 30.4K | 91.2K | 3289ms | ±1.8% |
| **List 변경: <sup><sub><kbd>LPUSH</kbd> <kbd>RPUSH</kbd> <kbd>LPOP</kbd> <kbd>RPOP</kbd> <kbd>LLEN</kbd></sub></sup>**<br/><sub>1 KB</sub> | **solidis** | 43.3K | 216.4K | 2311ms | ±2.4% |
|  | ioredis | 22.7K | 113.5K | 4407ms | ±5.4% |
| **Hash 변경: <sup><sub><kbd>HMSET</kbd> <kbd>HMGET</kbd> <kbd>HDEL</kbd></sub></sup>**<br/><sub>1 KB</sub> | **solidis** | 52.5K | 157.5K | 1904ms | ±3.0% |
...
| **List 범위: <sup><sub><kbd>LPUSH</kbd> <kbd>RPUSH</kbd> <kbd>LRANGE</kbd></sub></sup>**<br/><sub>1 KB</sub> | **solidis** | 53.9K | 161.6K | 1856ms | ±5.8% |
|  | ioredis | 29.2K | 87.5K | 3429ms | ±1.1% |
| **Set 조회: <sup><sub><kbd>SADD</kbd> <kbd>SISMEMBER</kbd> <kbd>SMEMBERS</kbd></sub></sup>**<br/><sub>1 KB</sub> | **solidis** | 57.3K | 171.9K | 1745ms | ±8.1% |
...
| **비트랜잭션: <sup><sub><kbd>SETPX</kbd> <kbd>GET</kbd></sub></sup>**<br/><sub>1 KB</sub> | **solidis** | 81.7K | 163.4K | 1224ms | ±3.1% |
...
| **Hash 왕복: <sup><sub><kbd>HSET</kbd> <kbd>HGET</kbd> <kbd>HGETALL</kbd></sub></sup>**<br/><sub>1 KB</sub> | **solidis** | 55.2K | 165.6K | 1811ms | ±4.8% |
|  | ioredis | 34.3K | 102.9K | 2917ms | ±1.5% |
| **파이프라인 혼합: <sup><sub><kbd>SET</kbd> <kbd>INCR</kbd> <kbd>GET</kbd></sub></sup>**<br/><sub>1 KB</sub> | **solidis** | 60.1K | 180.4K | 1663ms | ±9.0% |
